...
const AppHeaderDropdownStudent = () => {
  ...
  useEffect(() => {
    ...
    const fetchStudentDetails = async () => {
      try {
        const response = await axios.get(`https://cp-backend-jx53.onrender.com/api/student/GetById/${loggedInUserId.replace(/"/g, '')}`);
  ...
  const handleSaveChanges = () => {
    const updateStudent = async () => {
      try {
        ...
        const response = await axios.put(`https://cp-backend-jx53.onrender.com/api/student/update/${student._id}`, newFormData);
  ...
  return (
    <CDropdown variant="nav-item">
      <CDropdownToggle placement="bottom-end" className="py-0 pe-0" caret={false}>
        <CAvatar
          src={`https://cp-backend-jx53.onrender.com/api/upload/photo/${formData.s_photo}`}
          alt="profile"
      ...
      <CDropdownMenu className="pt-0" placement="bottom-end">
          ...
          <CModalBody>
            <CForm>
              <div className="mb-3">
                ...
                {!isEditing ? (
                  <img
                    ...
                    alt="Profile"
                    src={`https://cp-backend-jx53.onrender.com/api/upload/photo/${student.s_photo}`}
              ...
              <div className="mb-3">
                ...
                {!isEditing ? (
                  <a href={`https://cp-backend-jx53.onrender.com/api/upload/resume/${student.s_resume}`} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'yellow' }}>
                    {student.s_resume}
                  </a>
                ) : (
                  <CFormInput
        ...
        <CModal visible={photoModalVisible} onClose={() => setPhotoModalVisible(false)} size="lg">
          ...
          <CModalBody>
            <CImage fluid src={`https://cp-backend-jx53.onrender.com/api/upload/photo/${student.s_photo}`} alt="Profile" />
          </CModalBody>
          <CModalFooter>
