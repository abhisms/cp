...
const AppliedJobs = () => {
    ...
    useEffect(() => {
        axios.get(`https://cp-backend-e04k.onrender.com/api/application/applied/${student_id}`)
            .then((res) => {
            ...
            {applications.map(application => (
                <CCol xs="12" sm="6" md="4" key={application._id}>
                    <CCard className="mb-4">
                        ...
                        <CCardBody>
                             <CCardImage orientation="top" style={{ height: "200px", width: "100%", objectFit: "cover" }} src={`https://cp-backend-e04k.onrender.com/api/upload/${application.job_id.cover_photo}`} /> 
