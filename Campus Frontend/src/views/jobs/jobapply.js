...
const ApplyJob = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://cp-backend-jx53.onrender.com/api/student/GetById/${student_id.replace(/['"]+/g, '')}`)
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://cp-backend-jx53.onrender.com/api/application/insert', data)
            .then((res) => {
                if (res.data.success) {
