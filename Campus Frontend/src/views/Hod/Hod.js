...
const Tables = () => {
  ...
  const Edit = ({ item }) => {
    ...
    const handleEdit = () => {
      ...
      axios.put(`https://cp-backend-jx53.onrender.com/api/hod/update/${newHod._id}`, formData)
        .then((res) => {
          if (res.data.success) {
  ...
  const handleDelete = (id) => {
    if (window.confirm("Are you sure you want to delete this?")) {
      axios.delete(`https://cp-backend-jx53.onrender.com/api/hod/delete/${id}`)
        .then((res) => {
          if (res.data.success) {
                  ...
                  <CTableRow key={item._id}>
                    ...
                    <CTableDataCell>
                      <img
                        ...
                        alt=""
                        src={`https://cp-backend-jx53.onrender.com/api/upload/${item.h_photo}`}
                      />
                    </CTableDataCell>
                    <CTableDataCell>
                      <Edit item={item} />
